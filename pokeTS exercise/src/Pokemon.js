...
function getNewPokemons(constructor) {
    return /** @class */ (function (_super) {
        ...
        function class_1() {
            ...
            _this.listOfIds = generateRandomIds(4, 10, 20);
            return _this;
        }
        return class_1;
    }(constructor));
...
var Pokemon = /** @class */ (function () {
    ...
    Pokemon.prototype.displayInfo = function () {
        ...
        this.types.forEach(function (type) {
            console.log("Type: ".concat(type.type.name));
        });
        this.moves.forEach(function (move) {
            console.log("Move: ".concat(move.move.name));
        });
    };
    // pick 4 movements
    Pokemon.prototype.pickFourMoves = function (moves) {
        //sorts the array randomly and then picks the first 4 elements
        return moves.sort(function () { return Math.random() - 0.5; }).slice(0, 3);
    };
    return Pokemon;
}());
